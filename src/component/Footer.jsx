...
const Footer = () => {
    return (
        <footer className="footer items-center md:px-28  border-t p-3  dark:text-white text-black">
            ...
            <nav className="grid-flow-col place-self-center gap-4 md:place-self-center md:justify-self-end">

...
import myimge from '../../assets/myimgbgremove.png'
    ...
    return (
        <div className='min-h-[70vh] patternbg flex gap-4 items-center justify-center flex-col relative overflow-hidden pb-4 px-4 text-center'>
            ...
            <div className='flex justify-center items-center z-30'>
                <div >
                    <img src={myimge} alt="" srcset="" width={400} />
                </div>
                <div className='flex flex-col justify-center items-center gap-3 z-40'>
                    <p>Hi , I'm</p>
                    <h1 className='md:text-7xl text-2xl font-bold capitalize text-center'>Tanvir Rahman</h1>
                    <p className='tracking-wide text-4xl font-bold'>Django & React Devloper</p>
                    <p className='flex justify-center items-center gap-4 text-3xl'>
                        <BsFillTelephoneFill className='text-[#00dc82]' /> <p>01307629936</p>
                    </p>
                    <p className='flex justify-center items-center gap-4 text-3xl'>
                        <ImLocation2 className='text-[#00dc82]' /> <p>Dhaka,Bangladesh</p>
                    </p>
